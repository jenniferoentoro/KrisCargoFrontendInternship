...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Kapal</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('kapal') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Kapal' => [
                ['text', 'Kapal', [], 'KAPAL', 'required'],
                ['dropdown', 'Pelayaran/Vendor', $array_vendors_dropdown, 'KODE_VENDOR', 'required'],
                ['text', 'Keterangan', [], 'KETERANGAN', 'required'],
            ],
        ],
        'submit_route_name' => 'kapal.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'kapal.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'kapal.json',
        'data_adv_route_name' => 'kapal.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'kapal.findByKode',
        'delete_route_name' => 'kapal.delete',
        'next_id_route_name' => 'kapal.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'kapal.restore',
        'trash_route_name' => 'kapal.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
