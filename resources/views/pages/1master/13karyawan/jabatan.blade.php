...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Jabatan</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('jabatan') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        ...
        'submit_route_name' => 'jabatan.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'jabatan.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'jabatan.json',
        'data_adv_route_name' => 'jabatan.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'jabatan.findByKode',
        'delete_route_name' => 'jabatan.delete',
        'next_id_route_name' => 'jabatan.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'jabatan.restore',
        'trash_route_name' => 'jabatan.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
