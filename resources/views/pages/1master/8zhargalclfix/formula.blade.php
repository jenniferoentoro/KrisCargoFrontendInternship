...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Rumus</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('formula') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Rumus' => [['text', 'Nama Rumus', [], 'NAMA_RUMUS', 'required']],
        ],
        'submit_route_name' => 'formula.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'formula.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'formula.json',
        'data_adv_route_name' => 'formula.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'formula.findByKode',
        'delete_route_name' => 'formula.delete',
        'next_id_route_name' => 'formula.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'formula.restore',
        'trash_route_name' => 'formula.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
