...
@section('main')
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Products' => [
                ['text', 'Nama', [], 'NAMA_PRODUK', 'required'],
                ['dropdown', 'Kategori', $array_category_dropdown, 'KODE_KATEGORI', 'required'],
                ['dropdown', 'Rumus', $array_formula_dropdown, 'KODE_RUMUS', 'required'],
            ],
        ],
        'submit_route_name' => 'product.store',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'product.json',
        'data_adv_route_name' => 'product.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'product.findByKode',
        'delete_route_name' => 'product.delete',
        'next_id_route_name' => 'product.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'product.restore',
        'trash_route_name' => 'product.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
