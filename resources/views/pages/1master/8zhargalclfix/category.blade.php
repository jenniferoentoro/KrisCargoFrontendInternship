...
@section('main')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('category') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Kategori' => [['text', 'Nama Kategori', [], 'NAMA_KATEGORI', 'required']],
        ],
        'submit_route_name' => 'category.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'category.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'category.json',
        'data_adv_route_name' => 'category.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'category.findByKode',
        'delete_route_name' => 'category.delete',
        'next_id_route_name' => 'category.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'category.restore',
        'trash_route_name' => 'category.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
