...
@section('main')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('unit') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Satuan' => [['text', 'Nama Kategori', [], 'NAMA_SATUAN', 'required']],
        ],
        'submit_route_name' => 'unit.store',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'unit.json',
        'data_adv_route_name' => 'unit.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'unit.findByKode',
        'delete_route_name' => 'unit.delete',
        'next_id_route_name' => 'unit.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'unit.restore',
        'trash_route_name' => 'unit.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
