...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Size Container</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('ukuran') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Size Container' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'ukuran.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'ukuran.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'ukuran.json',
        'data_adv_route_name' => 'ukuran.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'ukuran.findByKode',
        'delete_route_name' => 'ukuran.delete',
        'next_id_route_name' => 'ukuran.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'ukuran.restore',
        'trash_route_name' => 'ukuran.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
