...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Jenis Container</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('jeniskontainer') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Jenis Container' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'jeniskontainer.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'jeniskontainer.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'jeniskontainer.json',
        'data_adv_route_name' => 'jeniskontainer.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'jeniskontainer.findByKode',
        'delete_route_name' => 'jeniskontainer.delete',
        'next_id_route_name' => 'jeniskontainer.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'jeniskontainer.restore',
        'trash_route_name' => 'jeniskontainer.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
