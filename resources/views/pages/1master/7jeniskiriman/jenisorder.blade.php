...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Jenis Order</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('jenisorder') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Jenis Order' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'jenisorder.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'jenisorder.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'jenisorder.json',
        'data_adv_route_name' => 'jenisorder.jsonadv',
    ])
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'jenisorder.findByKode',
        'delete_route_name' => 'jenisorder.delete',
        'next_id_route_name' => 'jenisorder.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'jenisorder.restore',
        'trash_route_name' => 'jenisorder.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
