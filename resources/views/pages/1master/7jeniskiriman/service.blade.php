...
@section('main')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('service') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Service' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'service.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'service.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'service.json',
        'data_adv_route_name' => 'service.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'service.findByKode',
        'delete_route_name' => 'service.delete',
        'next_id_route_name' => 'service.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'service.restore',
        'trash_route_name' => 'service.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
