...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Jenis Usaha</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('jenisusaha') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Jenis Usaha' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'jenisusaha.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'jenisusaha.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'jenisusaha.json',
        'data_adv_route_name' => 'jenisusaha.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'jenisusaha.findByKode',
        'delete_route_name' => 'jenisusaha.delete',
        'next_id_route_name' => 'jenisusaha.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'jenisusaha.restore',
        'trash_route_name' => 'jenisusaha.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
