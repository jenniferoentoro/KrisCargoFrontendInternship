...
@section('main')
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">THC LOLO POD</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('thclolopod') }}</div>
    ...
    @include('components.modal-input', [
        ...
        'submit_route_name' => 'thclolopod.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'thclolopod.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'thclolopod.json',
        'data_adv_route_name' => 'thclolopod.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'thclolopod.findByKode',
        'delete_route_name' => 'thclolopod.delete',
        'next_id_route_name' => 'thclolopod.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'thclolopod.restore',
        'trash_route_name' => 'thclolopod.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
