...
@section('main')
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">THC LOLO POL</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('thclolopol') }}</div>
    ...
    @include('components.modal-input', [
        ...
        'submit_route_name' => 'thclolopol.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'thclolopol.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'thclolopol.json',
        'data_adv_route_name' => 'thclolopol.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'thclolopol.findByKode',
        'delete_route_name' => 'thclolopol.delete',
        'next_id_route_name' => 'thclolopol.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'thclolopol.restore',
        'trash_route_name' => 'thclolopol.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
