...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Kelompok Biaya</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('costgroup') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Kelompok Biaya' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'costgroup.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'costgroup.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'costgroup.json',
        'data_adv_route_name' => 'costgroup.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'costgroup.findByKode',
        'delete_route_name' => 'costgroup.delete',
        'next_id_route_name' => 'costgroup.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'costgroup.restore',
        'trash_route_name' => 'costgroup.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
