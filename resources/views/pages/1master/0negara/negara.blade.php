...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Negara</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('negara') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Negara' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'negara.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'negara.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'negara.json',
        'data_adv_route_name' => 'negara.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'negara.findByKode',
        'delete_route_name' => 'negara.delete',
        'next_id_route_name' => 'negara.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'negara.restore',
        'trash_route_name' => 'negara.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
