...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Jenis Truck</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('truck') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Jenis Truck' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'truck.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'truck.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'truck.json',
        'data_adv_route_name' => 'truck.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'truck.findByKode',
        'delete_route_name' => 'truck.delete',
        'next_id_route_name' => 'truck.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'truck.restore',
        'trash_route_name' => 'truck.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
