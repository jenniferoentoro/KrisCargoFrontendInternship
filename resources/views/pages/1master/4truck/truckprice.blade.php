...
@section('main')
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Tarif Truck</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('truckprice') }}</div>
    ...
    @include('components.modal-input', [
        ...
        'submit_route_name' => 'truckprice.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'truckprice.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'truckprice.json',
        'data_adv_route_name' => 'truckprice.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'truckprice.findByKode',
        'delete_route_name' => 'truckprice.delete',
        'next_id_route_name' => 'truckprice.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'truckprice.restore',
        'trash_route_name' => 'truckprice.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
