...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Jenis Vendor</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('jenisvendor') }}</div>
                </div>
            </div>
            <div>
                <div>
    ...
    @include('components.modal-input', [
        'input_fields' => [
            'Jenis Vendor' => [['text', 'Nama', [], 'NAMA', 'required']],
        ],
        'submit_route_name' => 'jenisvendor.store',
    ])
    ...
    @include('components.modal-edit', [
        ...
        'submit_route_name' => 'jenisvendor.update',
    ])
...
@push('scripts')
    ...
    @include('components.data-table-ajax-scripts', [
        'keys' => $keys,
        'data_route_name' => 'jenisvendor.json',
        'data_adv_route_name' => 'jenisvendor.jsonadv',
    ])
    @include('components.data-table-advance-script')
    @include('components.modal-scripts', [
        'open_modal_edit_route_name' => 'jenisvendor.findByKode',
        'delete_route_name' => 'jenisvendor.delete',
        'next_id_route_name' => 'jenisvendor.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'jenisvendor.restore',
        'trash_route_name' => 'jenisvendor.trash',
        'columns' => $table_headers,
        'keys' => $keys,
    ])
    <script>
