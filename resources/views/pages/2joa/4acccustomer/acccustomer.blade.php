...
@section('main')
    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 style="text-align: center;">Acc Customer</h1>
                    <div style="margin-top: 15px;">{{ Breadcrumbs::render('acccustomer') }}</div>
                </div>
            </div>
            <div>
                <div>
...
@push('scripts')
    ...
    @include('components.approval-front-form-scripts', [
        ...
        'delete_route_name' => 'acccustomer.update',
        'next_id_route_name' => 'prajoa.getNextId',
        'continue_submit_route_name' => null,
        'continue_edit_submit_route_name' => null,
        'restore_route_name' => 'acccustomer.unapprove',
        'trash_route_name' => 'acccustomer.approved',
        'columns' => $table_headers,
        'keys' => $keys,
