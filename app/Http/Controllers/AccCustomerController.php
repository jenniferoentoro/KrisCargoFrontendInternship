...
class AccCustomerController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $url = env('API_URL') . "/acccustomer" . "/" . $request->KODE;
    ...
    {
        $providedToken = $request->cookie('token');
        $url = env('API_URL') . "/acccustomer/approved";
        //post with token
    ...
    {
        $providedToken = $request->cookie('token');
        $url = env('API_URL') . "/acccustomer/unapprove" . "/" . $request->KODE;
    ...
    public function index(Request $request)
    {
        ...
        $url_all_dropdown = env('API_URL') . "/acccustomer/dropdown";
        ...
        if ($length > 0) {
            ...
            return view('pages.2joa.4acccustomer.acccustomer', [
