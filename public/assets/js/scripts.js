...
$(function () {
    ...
    $(".nav-link.dropdown-toggle").on("click", function () {
        ...
        //     "touch-action": "auto",
        // });
        //css overflow hidden after 300ms
        var touch_action = $(".main-sidebar").css("touch-action");
        if (touch_action != "auto") {
            setTimeout(function () {
                $(".main-sidebar").css({
                    "touch-action": "auto",
                });
        ...
        //get touch action value
        //if touch action is none then set touch action to auto
